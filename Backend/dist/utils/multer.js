...
const fileFilter = (req, file, cb) => {
    ...
    if (file.fieldname === 'images') {
        ...
        const extname = imageExtensions.test(path_1.default.extname(file.originalname));
    ...
    // Accept videos
        ...
        const extname = videoExtensions.test(path_1.default.extname(file.originalname));
